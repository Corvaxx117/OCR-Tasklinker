 ...
 */
final class Version20251026183536 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP employee_id, CHANGE status status VARCHAR(255) DEFAULT \'TODO\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD employee_id INT NOT NULL, CHANGE status status VARCHAR(10) NOT NULL');
